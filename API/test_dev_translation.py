...
#   Ex (Spanish): 
#   python API/test_dev_translation.py es
...
JON_OUTPUT_PATH = os.path.join(os.path.dirname(__file__), f'tmp_test/test_subtitles_{dest_lang}.json')

print(f"🔍 Source language: {src_lang}")
print(f"🏁 Destination language: {dest_lang}")

start_time = time.time()
translate_str_and_json(TEXT_TO_TRANSLATE_PATH, SRT_OUTPUT_PATH, JON_OUTPUT_PATH, src_lang, dest_lang)
