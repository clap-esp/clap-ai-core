...
import sys
import time
from utils.lang_functions import translate_to_srt
...
translate_to_srt(TEXT_TO_TRANSLATE_PATH, SRT_OUTPUT_PATH, src_lang, dest_lang)

print(f"\n⏰ Translation process took {time.time() - start_time:.2f} seconds")
print(f"SRT output saved in {SRT_OUTPUT_PATH}")